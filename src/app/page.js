...
export const metadata = {
  title: "RoomieMatch — Verified AI College Roommate Finder",
  description:
    "AI-powered roommate matching exclusively for verified college students. Discover compatible roommates based on lifestyle, cleanliness, sleep schedule, and budget.",
};
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-slate-950/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center gap-2">
            <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-tr from-indigo-500 to-pink-500 font-extrabold text-white shadow-lg shadow-indigo-500/25">
              RM
            </span>
            <span className="text-xl font-extrabold tracking-tight">
              Roomie<span className="text-indigo-400">Match</span>
            </span>
          </Link>
          ...
          <nav className="flex items-center gap-3">
            ...
            <Link
              href="/sign-up"
              className="rounded-xl bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-600 px-4 py-2 text-xs font-bold text-white shadow-lg shadow-indigo-500/25 transition-all hover:scale-105 hover:shadow-indigo-500/40"
            >
              Get Verified (.edu) →
            </Link>
          </nav>
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden px-6 pt-16 pb-24 sm:pt-24 sm:pb-32">
          ...
          <div className="mx-auto max-w-4xl text-center relative z-10 space-y-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-indigo-300">
              <span className="h-2 w-2 rounded-full bg-indigo-400 animate-pulse" />
              <span>Verified College Students Only • PRD §3.1 &amp; §3.4</span>
            </div>

            <h1 className="text-4xl font-extrabold tracking-tight sm:text-6xl md:text-7xl leading-tight sm:leading-tight">
              Find Your Perfect{" "}
            ...
            <p className="mx-auto max-w-2xl text-base sm:text-lg text-slate-300 leading-relaxed">
              ...
              your university email, scores lifestyle compatibility across 6 key
